...
router.route("/update-teacher/:id").patch(validateUserUpdateInputs,validateUser,authorizeUser('principal'),updateTeacher);
router.route("/update-student/:id").patch(validateUserUpdateInputs,validateUser,authorizeUser('principal', 'teacher'),updateStudent);
